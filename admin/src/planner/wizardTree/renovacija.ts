  ...
  categories: [
    ...
    // ─────────────────────────────────────────────────────────
    {
      ...
      subcategories: [
        {
          id: "podovi_raspored",
          label: { sr: "Raspored podova po prostorijama", en: "Floor plan by room", ru: "Распределение полов по комнатам" },
          description: {
            sr: "Unesite broj prostorija i vrstu poda — ili odaberite tipove poda ispod za mešovitu kombinaciju",
            en: "Enter room count and floor type — or select individual types below for a mixed layout",
            ru: "Введите количество комнат и тип пола — или выберите типы пола ниже для смешанной планировки",
          },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
              label: { sr: "Broj prostorija (koje dobijaju novi pod)", en: "Number of rooms (getting new flooring)", ru: "Количество комнат (с новым полом)" },
              importance: "required",
              unit: "sob.",
            ...
            },
            {
              key: "isti_pod_svuda",
              kind: "toggle",
              label: { sr: "Isti pod u svim prostorijama", en: "Same flooring in all rooms", ru: "Одинаковый пол во всех комнатах" },
              importance: "required",
            },
            {
              key: "tip_za_sve",
              kind: "select",
              label: { sr: "Vrsta poda (za sve prostorije)", en: "Floor type (for all rooms)", ru: "Тип пола (для всех комнат)" },
              importance: "required",
              showWhen: { isti_pod_svuda: true },
              options: [
            ...
            },
            {
              key: "ukupna_povrsina",
              kind: "area",
              label: { sr: "Ukupna površina (sve prostorije zajedno)", en: "Total area (all rooms combined)", ru: "Общая площадь (все комнаты вместе)" },
              importance: "required",
              unit: "m²",
            ...
            },
            {
              key: "vrste_podova",
              kind: "chips",
              label: { sr: "Koje vrste podova trebate?", en: "Which floor types do you need?", ru: "Какие типы полов вам нужны?" },
              importance: "required",
              showWhen: { isti_pod_svuda: false },
              help: {
                sr: "Izaberite sve vrste poda koje se pojavljuju u različitim prostorijama. Detalje (površinu, materijal) unesite u odgovarajuće sekcije ispod.",
                en: "Select all floor types that appear in different rooms. Enter details (area, material) in the corresponding sections below.",
                ru: "Выберите все типы полов, которые встречаются в разных комнатах. Введите детали (площадь, материал) в соответствующие разделы ниже.",
              },
              options: [
                { value: "parket", label: { sr: "Parket", en: "Hardwood", ru: "Паркет" } },
                { value: "laminat", label: { sr: "Laminat", en: "Laminate", ru: "Ламинат" } },
                { value: "keramika", label: { sr: "Keramičke pločice", en: "Ceramic tiles", ru: "Керамическая плитка" } },
                { value: "brodski", label: { sr: "Brodski pod", en: "Plank flooring", ru: "Корабельная доска" } },
                { value: "vinil", label: { sr: "Vinil / SPC / LVT", en: "Vinyl / SPC / LVT", ru: "Винил / SPC / LVT" } },
            ...
            {
              key: "raspored_napomena",
              kind: "text",
              label: { sr: "Raspored po prostorijama (opciono)", en: "Room layout (optional)", ru: "Распределение по комнатам (необязательно)" },
              importance: "niceToHave",
              showWhen: { isti_pod_svuda: false },
              placeholder: {
                sr: "npr. Dnevna soba – parket 25m², Hodnik – keramika 8m², Spavaće sobe – laminat 30m²",
                en: "e.g. Living room – hardwood 25m², Hallway – tiles 8m², Bedrooms – laminate 30m²",
                ru: "напр. Гостиная – паркет 25m², Коридор – плитка 8m², Спальни – ламинат 30m²",
              },
            },
          ],
        },
        {
          id: "podovi_parket",
          label: { sr: "Parket", en: "Hardwood flooring", ru: "Паркет" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
              label: { sr: "Broj prostorija sa ovim podom", en: "Number of rooms with this flooring", ru: "Количество комнат с этим полом" },
              importance: "optional",
              unit: "sob.",
              predefined: [1, 2, 3, 4, 5, 6],
            },
            ...
            },
            {
              key: "vrsta_rada",
              kind: "select",
              label: { sr: "Vrsta rada", en: "Type of work", ru: "Вид работ" },
              importance: "required",
              options: [
                { value: "novo_postavljanje", label: { sr: "Postavljanje novog parketa", en: "Lay new flooring", ru: "Укладка нового паркета" } },
                { value: "brusenje_lakiranje", label: { sr: "Brušenje i lakiranje", en: "Sand and lacquer", ru: "Шлифовка и лакировка" } },
                { value: "reparatura", label: { sr: "Reparatura oštećenih dasaka", en: "Repair damaged boards", ru: "Ремонт повреждённых досок" } },
              ],
            },
            {
              key: "tip_parketa",
              kind: "select",
              label: { sr: "Tip parketa", en: "Flooring type", ru: "Тип паркета" },
              importance: "optional",
              options: [
                { value: "masivni", label: { sr: "Masivni parket", en: "Solid hardwood", ru: "Массивный паркет" } },
                { value: "troslojan", label: { sr: "Troslojan parket", en: "Engineered wood", ru: "Трёхслойный паркет" } },
                { value: "bambus", label: { sr: "Bambus", en: "Bamboo", ru: "Бамбук" } },
              ],
            ...
            },
            {
              key: "podloga",
              kind: "toggle",
              label: { sr: "Postavljanje podloge (estrih/nivelacija)", en: "Install screed / levelling", ru: "Укладка подложки (стяжка / нивелирование)" },
              importance: "optional",
              showWhen: { vrsta_rada: "novo_postavljanje" },
            },
            {
              key: "finisovanje",
              kind: "toggle",
              label: { sr: "Parket zahteva brušenje i lakiranje (nije pre-finišovan)", en: "Flooring requires sanding and lacquering (not pre-finished)", ru: "Паркет требует шлифовки и лакировки (не предварительно обработан)" },
              importance: "required",
              help: {
                sr: "Pre-finišovani (fabrički lakirani) parket ne zahteva hoblovanje i lakiranje nakon ugradnje.",
                en: "Pre-finished (factory-lacquered) flooring does not require sanding and lacquering after installation.",
                ru: "Предварительно обработанный (заводской лак) паркет не требует шлифовки и лакировки после укладки.",
              },
              showWhen: { vrsta_rada: "novo_postavljanje" },
            },
          ],
        ...
        {
          id: "podovi_laminat",
          label: { sr: "Laminat", en: "Laminate flooring", ru: "Ламинат" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
            ...
            },
            {
              key: "klasa",
              kind: "select",
              label: { sr: "Klasa otpornosti", en: "Wear resistance class", ru: "Класс износостойкости" },
              importance: "optional",
              options: [
                { value: "ac3", label: { sr: "AC3 (stambeni, manji promet)", en: "AC3 (residential, low traffic)", ru: "AC3 (жилой, малый трафик)" } },
                { value: "ac4", label: { sr: "AC4 (stambeni, veći promet)", en: "AC4 (residential, high traffic)", ru: "AC4 (жилой, высокий трафик)" } },
                { value: "ac5", label: { sr: "AC5 (komercijalni)", en: "AC5 (commercial)", ru: "AC5 (коммерческий)" } },
              ],
            },
            {
              key: "demontaza",
        ...
        {
          id: "podovi_keramika",
          label: { sr: "Keramičke pločice (podovi)", en: "Ceramic floor tiles", ru: "Керамическая плитка (полы)" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
            ...
            },
            {
              key: "format",
              kind: "select",
              label: { sr: "Format pločica", en: "Tile format", ru: "Формат плитки" },
              importance: "optional",
              options: [
                { value: "mali", label: { sr: "Mali format (do 30x30)", en: "Small (up to 30x30)", ru: "Малый формат (до 30x30)" } },
                { value: "srednji", label: { sr: "Srednji (30x60, 45x45)", en: "Medium (30x60, 45x45)", ru: "Средний (30x60, 45x45)" } },
                { value: "veliki", label: { sr: "Veliki format (60x60, 80x80, 60x120)", en: "Large (60x60+)", ru: "Крупный формат (60x60+)" } },
              ],
            },
            {
              key: "estrih",
              kind: "toggle",
              label: { sr: "Izrada estriha pre keramike", en: "Screed before tiling", ru: "Стяжка перед укладкой плитки" },
              importance: "optional",
            },
            {
              key: "demontaza",
        ...
        },
        {
          ...
          label: { sr: "Mikrocement / poliran beton", en: "Microcement / polished concrete", ru: "Микроцемент / полированный бетон" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
            ...
            },
            {
              ...
              importance: "required",
              options: [
                { value: "pod", label: { sr: "Pod", en: "Floor", ru: "Пол" } },
                { value: "zid", label: { sr: "Zid", en: "Wall", ru: "Стена" } },
                { value: "stepenice", label: { sr: "Stepenice", en: "Stairs", ru: "Лестница" } },
              ],
            },
          ],
        },
        {
          id: "podovi_brodski",
          label: { sr: "Brodski pod", en: "Plank flooring", ru: "Корабельная доска" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
            ...
            },
            {
              ...
              importance: "optional",
              options: [
                { value: "masivni", label: { sr: "Masivno drvo", en: "Solid wood", ru: "Массив дерева" } },
                { value: "troslojan", label: { sr: "Troslojan (inžinjering)", en: "Engineered wood", ru: "Инженерная доска" } },
                { value: "vinil_plank", label: { sr: "Vinil plank (LVT imitacija)", en: "Vinyl plank (LVT look)", ru: "Виниловая доска (имитация LVT)" } },
              ],
            },
            {
              key: "demontaza",
            ...
            },
            {
              key: "podloga",
              kind: "toggle",
              label: { sr: "Postavljanje podloge / nivelacija", en: "Install underlay / levelling", ru: "Укладка подложки / нивелирование" },
              importance: "optional",
            },
          ],
        },
        {
          id: "podovi_epoxy",
          label: { sr: "Epoksidni pod", en: "Epoxy flooring", ru: "Эпоксидный пол" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
            ...
            },
            {
              key: "tip",
              kind: "select",
              label: { sr: "Tip epoksida", en: "Epoxy type", ru: "Тип эпоксида" },
              importance: "optional",
              options: [
                { value: "jednobojni", label: { sr: "Jednobojni (standarni)", en: "Solid colour (standard)", ru: "Однотонный (стандарт)" } },
                { value: "metalik", label: { sr: "Metalik / 3D efekat", en: "Metallic / 3D effect", ru: "Металлик / 3D эффект" } },
                { value: "kvarcni", label: { sr: "Kvarcni posip", en: "Quartz broadcast", ru: "Кварцевая посыпка" } },
                { value: "prozirni", label: { sr: "Prozirni zapečaćivač", en: "Clear sealer", ru: "Прозрачный герметик" } },
              ],
            },
            {
              key: "priprema_podloge",
              kind: "select",
              label: { sr: "Stanje podloge", en: "Substrate condition", ru: "Состояние основания" },
              importance: "required",
              options: [
                { value: "dobro", label: { sr: "Dobro — samo čišćenje i prajmer", en: "Good — clean and prime only", ru: "Хорошее — только очистка и грунтовка" } },
                { value: "srednje", label: { sr: "Srednje — krpljenje pukotina", en: "Fair — crack repair needed", ru: "Среднее — требуется заделка трещин" } },
                { value: "lose", label: { sr: "Loše — kompletna priprema / estrih", en: "Poor — full prep / screed needed", ru: "Плохое — полная подготовка / стяжка" } },
              ],
            },
          ],
        },
        {
          id: "podovi_vinil",
          label: { sr: "Vinil / SPC / LVT", en: "Vinyl / SPC / LVT", ru: "Винил / SPC / LVT" },
          fields: [
            {
              key: "broj_prostorija",
              kind: "number",
            ...
            },
            {
              key: "tip",
              kind: "select",
              label: { sr: "Tip vinila", en: "Vinyl type", ru: "Тип винила" },
              importance: "optional",
              options: [
                { value: "spc", label: { sr: "SPC (krut, vodootporan)", en: "SPC (rigid, waterproof)", ru: "SPC (жёсткий, водостойкий)" } },
                { value: "lvt", label: { sr: "LVT (luksuzni vinil pločice)", en: "LVT (luxury vinyl tile)", ru: "LVT (роскошная виниловая плитка)" } },
                { value: "wpc", label: { sr: "WPC (drvo-plastika kompozit)", en: "WPC (wood-plastic composite)", ru: "WPC (древесно-пластиковый композит)" } },
              ],
            },
            {
              key: "demontaza",
