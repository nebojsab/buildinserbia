          ...
          fields: [
            {
              ...
              importance: "required",
              options: [
                { value: "temeljne_trake", label: { sr: "Temeljne trake (armirani beton)", en: "Strip foundations (reinforced concrete)", ru: "Ленточный фундамент (армированный бетон)" } },
                { value: "temeljna_ploca", label: { sr: "Temeljna ploča (armirani beton)", en: "Raft foundation (reinforced concrete)", ru: "Плитный фундамент (армированный бетон)" } },
                { value: "stubovi_samci", label: { sr: "Stupni temelji / samci", en: "Pad foundations / isolated footings", ru: "Столбчатый фундамент / отдельные опоры" } },
                { value: "sipovi", label: { sr: "Šipovi (za loše tlo)", en: "Piles (for poor ground)", ru: "Сваи (для слабого грунта)" } },
              ],
            },
            {
              key: "kubatura_betona",
              kind: "number",
              label: { sr: "Okvirna kubatura betona (m³)", en: "Approx. concrete volume (m³)", ru: "Ориентировочный объём бетона (м³)" },
              importance: "optional",
              unit: "m³",
