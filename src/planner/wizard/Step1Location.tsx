...
export function Step1Location({ location, onChange, i18n }: Props) {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 480 }}>
        <div>
          <label
            style={{ display: "block", fontSize: "0.875rem", fontWeight: 600, color: "var(--ink2)", marginBottom: 6 }}
          >
          ...
          <input
            className="finput"
            type="text"
            placeholder={i18n.municipalityPlaceholder}
            value={municipality}
        ...
        <div>
          <label
            style={{ display: "block", fontSize: "0.875rem", fontWeight: 600, color: "var(--ink2)", marginBottom: 10 }}
          >
            {i18n.zoneLabel}
          </label>
